# Tareas: Monitoreo Multimedia y Llamadas

- [x] Actualizar `NotificationCaptureService.kt`
    - [x] Implementar mapa de nombres amigables de apps
    - [x] Detectar llamadas (`CATEGORY_CALL`)
